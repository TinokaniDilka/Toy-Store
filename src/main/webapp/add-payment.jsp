    ...
    <div class="container">
        <div class="payment-container">
            <div class="text-center">
                ...
                <h1 class="store-title">Complete Payment</h1>
                <c:if test="${not empty lastOrderId}">
                    <div class="alert alert-success">
                        Order <strong>${lastOrderId}</strong> placed!
                        Total: <strong>$${lastOrderTotal}</strong> — enter payment details below.
                    </div>
                </c:if>
                <p class="text-muted">Step 3 of 3: Pay for your order</p>
            </div>
