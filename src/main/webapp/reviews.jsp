...
<body>
    ...
    <div class="container py-5">
        <div class="text-center mb-4">
            <h1 class="store-title">Product Reviews</h1>
            <c:if test="${not empty selectedProductId}">
                <p class="text-muted">Reviews for product: <strong>${selectedProductId}</strong></p>
            </c:if>
        </div>
        <div class="card mb-4">
                ...
                <form action="review" method="post" class="row g-3 review-form align-items-end">
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" name="productId"
                               value="${selectedProductId != null ? selectedProductId : param.productId}" required>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">Your Email</label>
                        <input type="text" class="form-control" name="userId"
                               value="${sessionScope.user.email}" placeholder="Login to auto-fill" required>
                    </div>
                    <div class="col-md-2">
