...
<c:if test="${empty sessionScope.admin or sessionScope.admin.role != 'SUPER_ADMIN'}">
...
<head>
    ...
    <title>Toy Store - Add Admin</title>
...
<body>
    ...
    <div class="container">
        <div class="register-container">
            <a href="${pageContext.request.contextPath}/admin/list" class="btn-back">
            ...
            <div class="text-center">
                ...
                <span class="admin-badge">
                    <i class="fas fa-crown"></i> Add New Admin
                </span>
