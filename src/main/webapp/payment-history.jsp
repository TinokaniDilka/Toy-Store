            ...
            <div class="text-center">
                ...
                <c:if test="${param.paid == 'true'}">
                    <div class="alert alert-success">
                        Payment saved successfully! Thank you for shopping at Toy Store.
                        <a href="${pageContext.request.contextPath}/list-toys" class="alert-link">Continue shopping</a>
                    </div>
                </c:if>
            </div>

            <div class="text-center">
                <a href="${pageContext.request.contextPath}/add-payment" class="add-payment-btn">
